...
validateKata gilded-rose-characterization-testing "cd gilded-rose-characterization-testing" "make coverage" "make mutation"
validateKata weather-kata "cd weather-kata" "make test" "make coverage"
validateKata trip-service-kata "cd trip-service-kata" "make test" "make coverage"
